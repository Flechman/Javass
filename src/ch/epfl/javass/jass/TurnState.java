...
/**
 * Class which represents the state of a turn
 */
public final class TurnState {
    ...
    /**
     * Getter for the packed representation of the score 
    ...
    /**
     * Getter for the packed representation of cards not yet played in the turn 
     * @return (long) : the cards not yet played in the turn
     */
    ...
    /**
     * Getter for the packed representation of current trick of the turn
    ...
    /**
     * Checks if the last trick has been played
    ...
    /**
     * Returns the updated state of the turn, with the specified card added to the current trick
    ...
    /**
     * Give the turn state after that the trick has been collected
    ...
    /**
     * Adds the given card to the trick and collects it if it is full
