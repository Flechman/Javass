...
public final class CardSet {
    ...
    //Packed representation of the set of cards
    ...
    /**
     * Gives every card contained in the list 
    ...
    /**
     * Gives every card contained in the specified set of packed cards 
     * @param packed (long): the packed representation of the set of cards
     * @return (CardSet): the set of cards contained in packed
     */
    ...
    /**
     * Creates a set that contains all the cards of the card set and all the cards of the specified "that" set
     ...
     * @return (CardSet): the subset which contain all the cards of color "color"
     */
