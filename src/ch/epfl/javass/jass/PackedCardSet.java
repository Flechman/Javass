...
/**
 * Class which contains methods to manipulate sets of cards of the game
 */
public final class PackedCardSet {
    ...
    /**
     * Returns the number of cards in the set of the packed cards
    ...
    /**
     * Checks if the specified set of packed cards contains a specified card
     * @param pkCardSet (long): the set of packed cards
     * @param pkCard (int): the packed card 
     * @return (boolean): true if the pkCardSet contains pkCard
     */
    public static boolean contains(long pkCardSet, int pkCard) {
        //assert isValid(pkCardSet);
        long newCard = singleton(pkCard);

        if((pkCardSet | newCard)==pkCardSet) {
            return true;
        }
        return false;
    }
    /**
     * Returns the complement of the given set of packed cards
     * @param pkCardSet (long): the set of packed cards
    ...
    /**
     * Returns the union of all the cards of the first set of packed cards and the second set of packed cards
    ...
    /**
     * Returns the packed cards that a first set and a second set of packed cards have in common 
    ...
    /**
     * Returns the packed cards that are contained in the first set of packed card but not in the second
     * @param pkCardSet1 (long): the first set
     * @param pkCardSet2 (long): the second set
    ...
    /**
     * Returns the subset of the set of packed cards which only contain cards that have the specified color
     * @param pkCardSet (long): the set of the packed cards
