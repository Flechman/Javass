...
/**
 * Class which contains methods to manipulate the points of the game
 */
public final class PackedScore {
    ...
    /**
     * Takes 6 integers and packs them into one integer by putting them side by side in their binary representation
    ...
    /**
     * Allows access to the number of tricks obtained by a specified team
     * @param pkScore (long): the packed representation of the score
    ...
    /**
     * Allows access to the number of points scored by a specified team during the current turn
     * @param pkScore (long): the packed representation of the score
     * @param t (TeamId): the specified team
    ...
    /**
     * Allows access to the number of points scored by a specified team during the full game
     * @param pkScore (long): the packed representation of all the score
     * @param t (TeamId): the specified team
    ...
    /**
     * Sums up the points scored by a specified team during the game with the points scored by this team during the current 
    ...
    /**
     * A spare method that allows us to extract the scores we need in the above methods for a specified team
     * @param pkScore (long): the packed representation of the score
    ...
    /**
     * Adds up the points scored by the specified team during the current round to the total points won 
     ...
     * @return (long): the updated packed representation of all the scores during the game
     */
    ...
    /**
     * Resets the points scored by the two teams at the end of the round and the number of tricks won
     * Updates the scores of the two teams
     * @param pkScore (long): the packed representation of all the scores
     * @return (long): an updated packed representation of all the scores during the game
     */
    ...
    private static long reinitScore(long score) {
        long turnPoints= turnPoints(score, TeamId.TEAM_1);
        long gamePoints = gamePoints(score, TeamId.TEAM_1);

        score =INITIAL;
        gamePoints +=turnPoints;
    ...
    /**
     * Useful to represent the scores graphically
     * @param pkScore (long): the packed representation of all the scores
